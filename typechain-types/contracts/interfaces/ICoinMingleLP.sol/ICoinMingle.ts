...
export interface ICoinMingleInterface extends utils.Interface {
  functions: {
...
export interface ICoinMingle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICoinMingleInterface;
  ...
  functions: {
    ...
    tokenA(overrides?: CallOverrides): Promise<[string] & { _tokenA: string }>;
